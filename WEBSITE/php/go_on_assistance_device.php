<?php
        if($_SERVER["REQUEST_METHOD"]=="POST"){
			...
			$query="SELECT device.categoria AS categoria, device.filtro AS tipo, device.marca AS marca, device.nome AS nome FROM device JOIN for_device_2as ON device.id_device=for_device_2as.id_device WHERE for_device_2as.id_device='$id_device' AND for_device_2as.nome_assistenza='$nome_assistenza'";
